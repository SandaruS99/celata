                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                        ...
                        <div>
                            ...
                            <div className="mt-8 flex gap-3">
                                {/* Facebook */}
                                <a href="#" className="flex h-8 w-8 items-center justify-center rounded bg-white text-brand-blue-deep hover:bg-brand-red-light hover:text-white transition-colors">
                                ...
                                {/* YouTube */}
                                <a href="#" className="flex h-8 w-8 items-center justify-center rounded bg-white text-brand-red-light hover:bg-brand-red-light hover:text-white transition-colors">
