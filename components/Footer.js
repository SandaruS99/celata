                ...
                <div className="container relative z-10 mx-auto max-w-7xl">
                    ...
                    <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
                        <div className="flex gap-4 order-1 md:order-1">
                            {/* Facebook */}
                            <a href="#" className="flex h-8 w-8 items-center justify-center rounded bg-white text-brand-blue-deep hover:bg-brand-red-light hover:text-white transition-all transform hover:scale-110">
                            ...
                            {/* YouTube */}
                            <a href="#" className="flex h-8 w-8 items-center justify-center rounded bg-white text-brand-red-light hover:bg-brand-red-light hover:text-white transition-all transform hover:scale-110">
